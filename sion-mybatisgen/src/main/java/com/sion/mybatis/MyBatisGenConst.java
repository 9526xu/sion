...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.lol.sion.core.dao";
    public static final String DO_PACKAGE = "com.lol.sion.core.dao.dataobject";
    public static final String QUERY_PACKAGE="com.lol.sion.core.dao.query";
    public static final String MAPPER_PACKAGE = "com.lol.sion.core.dao.mapper";
    public static final String MANAGER_PACKAGE= "com.lol.sion.core.dao.intf";
    public static final String MANAGER_IMPL_PACKAGE= "com.lol.sion.core.dao.impl";

    public static final String MAPPER_EXT_PACKAGE = "com.lol.sion.core.dao.mapper.ext";
    public static final String TABLE_PREFIX = "b2b_";
    ...
    // mapper xml 输出目录
    public static final String MAPPER_XML_DIR = WORK_DIR + "sion-dal/src/main/resources/mybatis/";
    // mapper-ext xml 输出目录
    public static final String MAPPER_EXT_XML_DIR = WORK_DIR + "sion-dal/src/main/resources/mybatis/ext/";
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "sion-dal/src/main/java/com/lol/sion/core/dao/dataobject";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "sion-dal/src/main/java/com/lol/sion/core/dao/query";
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = WORK_DIR + "sion-dal/src/main/java/com/lol/sion/core/dao/mapper";

    public static final String MANAGER_JAVA_DIR = WORK_DIR + "sion-dal/src/main/java/com/lol/sion/core/dao/intf";
    public static final String MANAGER_IMPL_JAVA_DIR = "sion-dal/src/main/java/com/lol/sion/core/dao/impl";



    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "sion-dal/src/main/java/com/lol/sion/core/dao/mapper/ext";
    // java数据对象类模板
